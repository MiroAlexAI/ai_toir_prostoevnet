...
2. Если invalid, укажи конкретную причину и предложи ОДИН реально существующий пример аналогичного оборудования (модель и производитель), который точно пройдет проверку.
...
Ответь СТРОГО В ФОРМАТЕ JSON следующей структуры:
{
  ...
  "suggestion": "пример оборудования для проверки если invalid",
